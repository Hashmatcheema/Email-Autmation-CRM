    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="mt-0.5 text-xs text-slate-500">
          {loading
            ...
            : total === 0
            ? 'No follow-ups due'
            : `${total} lead${total !== 1 ? 's' : ''} with follow-up due`}
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-slate-200 bg-white px-6 py-16 text-center">
          ...
          <p className="mt-3 text-sm font-medium text-slate-500">No follow-ups due today.</p>
          <p className="mt-1 text-xs text-slate-400">
            Leads with a past or today&apos;s follow-up date will appear here.
          </p>
        </div>
      ) : (
